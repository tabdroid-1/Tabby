...
ExampleLayer::ExampleLayer() 
	: Layer("ExampleLayer"), m_CameraController(1300.0f / 720.0f)
{
	...
	m_Texture = Tabby::Texture2D::Create("assets/textures/Checkerboard2.png");
	m_ChernoLogoTexture = Tabby::Texture2D::Create("assets/textures/tabbyv2.png");
