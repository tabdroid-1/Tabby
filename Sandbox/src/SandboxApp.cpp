...
ExampleLayer::ExampleLayer()
    ...
    Tabby::Ref<Tabby::VertexBuffer> vertexBuffer;
    vertexBuffer.reset(Tabby::VertexBuffer::Create(vertices, sizeof(vertices)));
    ...
    Tabby::Ref<Tabby::IndexBuffer> indexBuffer;
    indexBuffer.reset(Tabby::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t)));
    ...
    Tabby::Ref<Tabby::VertexBuffer> squareVB;
    squareVB.reset(Tabby::VertexBuffer::Create(squareVertices, sizeof(squareVertices)));
    squareVB->SetLayout({
                                {Tabby::ShaderDataType::Float3, "a_Position"},
    ...
    Tabby::Ref<Tabby::IndexBuffer> squareIB;
    squareIB.reset(Tabby::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t)));
    ...
    m_BLogoTexture = Tabby::Texture2D::Create("assets/textures/logoB_no_bkgd.png");

    // Bind and upload shader
    std::dynamic_pointer_cast<Tabby::OpenGLShader>(textureShader)->Bind();
    std::dynamic_pointer_cast<Tabby::OpenGLShader>(textureShader)->UploadUniformInt("u_Texture", 0);
...
void ExampleLayer::OnUpdate(Tabby::Timestep ts) {
    ...
    std::dynamic_pointer_cast<Tabby::OpenGLShader>(m_FlatColorShader)->UploadUniformFloat3("u_Color", m_SquareColor);
